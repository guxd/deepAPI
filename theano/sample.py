...
def sample(lm_model, seq, n_samples,
    ...
    if beam_search:
        sentences = []
        c, trans, costs = beam_search.search(seq, n_samples,
...
def parse_args():
    ...
    defaultvecfile=defaultfolder+'result.vec.shuf.txt'
    ...
    parser.add_argument("--verbose",
            action="store_true", default=True, help="Be verbose")
...
def main():
    ...
    if args.source and args.trans:
        ...
        for i, line in enumerate(fsrc):
            ...
            if args.verbose:
                print ("Parsed Input {}:".format(i), parsed_in)
