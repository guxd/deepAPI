    ...
    def __add__(self, other):
        ...
        if hasattr(new_obj, 'grads') and hasattr(other, 'grads'):
            for param, grad_param in zip(other.params, other.grads):
                ...
                other.ndim == 0:
            other_grads = TT.grad(other, new_obj.params,disconnected_inputs='warn'
                                  )
...
class Model(Container):
    ...
    def __init__(self, output_layer, sample_fn, word_dict, word_dict_src=None, rng =None):
        ...
        self.word_dict = word_dict #Path to the index_to_word dictionary file
        self.word_dict_src = word_dict_src #Path to the index_to_word dictionary file of source language
